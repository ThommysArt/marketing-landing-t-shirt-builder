  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-black text-white">
      ...
      <section className="mx-auto flex min-h-[70vh] max-w-6xl flex-col justify-center px-6 pb-20">
        <p className="mb-6 text-sm uppercase tracking-[0.35em] text-indigo-300">Five Distinct Design Directions</p>
        <h1 className="max-w-4xl text-5xl font-semibold leading-tight md:text-7xl">
          Choose a landing concept and launch the custom tee experience at full power.
        </h1>
